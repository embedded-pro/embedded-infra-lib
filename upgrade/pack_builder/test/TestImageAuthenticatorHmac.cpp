...
public:
    ...
    const std::array<uint8_t, 32> hmacKey{ { 0xeb, 0x57, 0xed, 0x0c, 0x74, 0xbb, 0xba, 0x99,
...
TEST_F(TestImageAuthenticatorHmac, Secure)
{
    EXPECT_EQ((std::vector<uint8_t>{
                  ...
                  0x36, 0xc9, 0x2f, 0x54, 0x02, 0xbd, 0x37, 0xed }),
        authenticator.GenerateMac(std::vector<uint8_t>{ 1, 2, 3, 4 }));
}
