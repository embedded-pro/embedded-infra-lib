...
namespace
{
    ...
    std::vector<uint8_t> MakeBfpt()
    {
        ...
        bfpt[4] = 0xFF; bfpt[5] = 0xFF; bfpt[6] = 0xFF; bfpt[7] = 0x07;
        // DW3 [8-11]: no fast-read quad entry
        // DW4 [12-15]: erase type 1 (size_exp=0x0C→4096, cmd=0x20) + erase type 2 (size_exp=0x10→65536, cmd=0xD8)
        bfpt[12] = 0x0C; bfpt[13] = 0x20; bfpt[14] = 0x10; bfpt[15] = 0xD8;
