#include "services/network/tls/TracingConnectionMbedTls.hpp"
...
namespace services
{
    ...
    bool AllocatorTracingConnectionMbedTlsAdapter::NoneAllocated() const
    {
        return allocator.NoneAllocated();
    }
