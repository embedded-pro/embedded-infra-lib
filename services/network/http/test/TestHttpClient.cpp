...
TEST_F(HttpClientTest, Put_request_with_content_size_is_executed)
{
    Connect();
...
TEST_F(HttpClientTest, Post_request_with_content_size_is_executed)
{
    Connect();
    ...
    client.Subject().Post("/api/thing", 4);
    ExecuteAllActions();
