...
TEST(AddressTest, ParseIpv4Address)
{
    ...
    EXPECT_EQ(std::nullopt, services::ParseIpv4Address("111.122.133.444"));
    EXPECT_EQ(std::nullopt, services::ParseIpv4Address("111.122.133."));
    EXPECT_EQ(std::nullopt, services::ParseIpv4Address("111.122.133.144."));
    EXPECT_EQ(std::nullopt, services::ParseIpv4Address("111.122.3.1A"));
    EXPECT_EQ(std::nullopt, services::ParseIpv4Address("111.122.3.0144"));
}
...
TEST(AddressTest, ParseFullIpv6Address)
{
    ...
    EXPECT_EQ(std::nullopt, services::ParseFullIpv6Address("1111:2222:3333:4444:5555:6666:7777:"));
    EXPECT_EQ(std::nullopt, services::ParseFullIpv6Address("1111:2222:3333:4444:5555:6666:7777:8888:"));
    EXPECT_EQ(std::nullopt, services::ParseFullIpv6Address("1111:2222:3333:4444:5555:6666:7777:888G"));
    EXPECT_EQ(std::nullopt, services::ParseFullIpv6Address("1111:2222:3333:4444:5555:6666:7777:88889"));
}
...
TEST(AddressTest, ParseIpAddress)
{
    ...
    EXPECT_EQ(std::nullopt, services::ParseIpAddress("111.122.133."));
    EXPECT_EQ(std::nullopt, services::ParseIpAddress("1111:2222:3333:4444:5555:6666:7777:"));
}
