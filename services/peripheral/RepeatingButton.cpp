#include "services/peripheral/RepeatingButton.hpp"

namespace services
{
    RepeatingButton::RepeatingButton(hal::GpioPin& buttonPin, infra::Function<void()> aCallback)
        : RepeatingButton(buttonPin, aCallback, Config{})
    {}
