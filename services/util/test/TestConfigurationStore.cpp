...
public:
    ...
    void RecoverFromFlash()
    {
        ...
        configurationBlob.Recover([this](bool success)
            {
                OnLoaded(success);
            });
...
class ConfigurationBlobMemoryTest
    : public testing::Test
{
public:
    ConfigurationBlobMemoryTest()
...
TEST_F(FactoryDefaultConfigurationStoreTest, failed_factory_default_results_in_OnLoadFactoryDefault)
{
    ...
    EXPECT_CALL(*this, OnLoadFactoryDefault()).WillOnce(testing::Invoke([this]()
        {
...
TEST_F(FactoryDefaultConfigurationStoreIntegrationTest, start_with_empty_flash_results_in_load_default)
{
    ...
    EXPECT_CALL(*this, OnLoadFactoryDefault()).WillOnce(testing::Invoke([&]()
        {
    ...
    EXPECT_EQ((std::vector<uint8_t>{
                  ...
                  0x02, 0x01, 0x08, 0x07, 0x06, 0x05, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff }),
        flashFactoryDefault.sectors[0]);
    EXPECT_EQ((std::vector<uint8_t>{
                  0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
                  0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff }),
        flashBlob1.sectors[0]);
    EXPECT_EQ((std::vector<uint8_t>{
                  0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
                  0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff }),
        flashBlob2.sectors[0]);
}
...
TEST_F(FactoryDefaultConfigurationStoreIntegrationTest, factory_default_is_recovered_but_blobs_are_corrupt)
{
    ...
    EXPECT_EQ((std::vector<uint8_t>{
                  ...
                  0x05, 0x07, 0x09, 0x02, 0x04, 0x06, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff }),
        flashBlob1.sectors[0]);
    EXPECT_EQ((std::vector<uint8_t>{
                  0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
                  0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff }),
...
class FactoryDefaultConfigurationStoreReadOnlyMemoryIntegrationTest
    : public testing::Test
    , public infra::EventDispatcherFixture
{
public:
    FactoryDefaultConfigurationStoreReadOnlyMemoryIntegrationTest()
        : flashBlob1(1, 32)
        , flashBlob2(1, 32)
    {}
...
public:
    services::Sha256MbedTls sha256;
    const std::array<uint8_t, 24> factoryDefault{ { 0x0a, 0x00, 0x00, 0x00, 0x0a, 0x08, 0x04, 0x03,
        0x02, 0x01, 0x08, 0x07, 0x06, 0x05, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff } };
