...
namespace services
{
    ...
    public:
        ...
        MOCK_METHOD(void, UpdateBondedDevice, (hal::MacAddress address), (override));
        ...
        MOCK_METHOD(void, IterateBondedDevices, (const infra::Function<void(hal::MacAddress)>& onAddress), (override));
    };
