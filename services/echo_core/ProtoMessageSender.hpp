...
#include "services/echo_core/Proto.hpp"
...
namespace services
{
    ...
    template<class Enum>
    bool ProtoMessageSenderBase::SerializeField(ProtoEnum<Enum>, infra::ProtoFormatter& formatter, const Enum& value, uint32_t fieldNumber, [[maybe_unused]] const bool& retry) const
    {
    ...
    bool ProtoMessageSenderBase::SerializeField(ProtoMessage<Message>, infra::ProtoFormatter& formatter, const Message& value, uint32_t fieldNumber, bool& retry) const
    {
        ...
        stack.emplace_back(0, [this, &value](infra::DataOutputStream& stream, uint32_t& index, bool& retry2, const infra::StreamWriter& finalWriter)
            {
                return FillForMessage(stream, value, index, retry2, finalWriter);
            });
