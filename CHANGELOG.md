...
## [8.0.0](https://github.com/embedded-pro/embedded-infra-lib/compare/v7.2.0...v8.0.0) (2026-09-26)


### ⚠ BREAKING CHANGES

* **hal:** hal::WatchdogQemu no longer takes onExpired nor the feed and expiration settings; construct a services::EventLoopWatchdog on top of it.
* **drivers:** SetReset(true) now drives the reset pin high instead of low, and the reset pin starts low. Boards that inverted RESET to match the old behaviour must drop the inversion.
* **hal:** implementations and callers of the PWM interfaces pass hal::FractionalPercent instead of hal::Percent.
* **ble:** GapCentral implementations must provide SetDataLength and SetPhy. GapDataLength carries maxTxOctets and maxTxTime, so it must now be constructed with a value; GapDataLength::Maximum builds the longest payload for a PHY.
* **ble:** IoCapabilitiesEnum values are renumbered in GapCentral.proto and GapPeripheral.proto. Ports that persist or transmit these values must remap them.
* GattClient, GattClientObserver, GattClientDiscovery, GattClientDiscoveryObserver, GattClientCharacteristicOperations, GattClientStackUpdateObserver, AttMtuExchange and AttMtuExchangeObserver are removed in favour of GattClientConnection, GattClientConnectionObserver and GattClientUpdateObserver. GattClient.hpp is replaced by GattClientConnection.hpp and GattClientCharacteristic.hpp.
* GapPeripheral::SetAdvertisementData, SetScanResponseData, Advertise, Standby and SetConnectionParameters take an onDone callback and return GapRequestStatus instead of void.
* sesame stack which does not execute in interrupt context ([#514](https://github.com/embedded-pro/embedded-infra-lib/issues/514))
* refactor adc to support multiple samples ([#530](https://github.com/embedded-pro/embedded-infra-lib/issues/530))
* generic pairing/bonding classes updated ([#330](https://github.com/embedded-pro/embedded-infra-lib/issues/330))
* ble interface improvements ([#300](https://github.com/embedded-pro/embedded-infra-lib/issues/300))
* security for MessageCommunication ([#294](https://github.com/embedded-pro/embedded-infra-lib/issues/294))

### Features

* Add 256bit ecdsa key support for upgrade pack builder ([#657](https://github.com/embedded-pro/embedded-infra-lib/issues/657)) ([a72b4d4](https://github.com/embedded-pro/embedded-infra-lib/commit/a72b4d4a85df0a207675c64a09c630d59a26b20c))
* Add aes ecb and cmac ([#15](https://github.com/embedded-pro/embedded-infra-lib/issues/15)) ([5b201c6](https://github.com/embedded-pro/embedded-infra-lib/commit/5b201c62a0befb376e4dd691424b900d009fa867))
* Add CMSDK watchdog driver for the QEMU MPS2 machines ([#139](https://github.com/embedded-pro/embedded-infra-lib/issues/139)) ([8d40117](https://github.com/embedded-pro/embedded-infra-lib/commit/8d40117fbc7e8e6dd62405bdf88e5bd601b1a28b))
* Add connection factory with name resolver mbed tls ([#536](https://github.com/embedded-pro/embedded-infra-lib/issues/536)) ([af200d2](https://github.com/embedded-pro/embedded-infra-lib/commit/af200d2262340ed065ed36dade63ea9639210231))
* Add custom clang-format file support ([#668](https://github.com/embedded-pro/embedded-infra-lib/issues/668)) ([3653875](https://github.com/embedded-pro/embedded-infra-lib/commit/3653875fa54af2f6c5f610e07177a044821c3b86))
* Add documentation ([#223](https://github.com/embedded-pro/embedded-infra-lib/issues/223)) ([d710807](https://github.com/embedded-pro/embedded-infra-lib/commit/d7108073d4bc139899bbffd0f46de487d5f591ad))
* Add ExecuteUntil to event dispatchers, add EventDispatcherThreadAware ([#526](https://github.com/embedded-pro/embedded-infra-lib/issues/526)) ([d05d1f3](https://github.com/embedded-pro/embedded-infra-lib/commit/d05d1f3fb8272ebe48407cfa42cfe9c938683106))
* Add FlashHeterogenous ([#549](https://github.com/embedded-pro/embedded-infra-lib/issues/549)) ([a0deadb](https://github.com/embedded-pro/embedded-infra-lib/commit/a0deadb8bd6800b1cda2a1c28f3f4d2713b37c04))
* Add generic Cortex-M layer (startup, interrupts, fault tracer) ([#95](https://github.com/embedded-pro/embedded-infra-lib/issues/95)) ([b1056e8](https://github.com/embedded-pro/embedded-infra-lib/commit/b1056e80ab5376d7e4ee821c5b3c5680bc01f751))
* Add generic finite state machine as services/fsm ([#140](https://github.com/embedded-pro/embedded-infra-lib/issues/140)) ([edeb62c](https://github.com/embedded-pro/embedded-infra-lib/commit/edeb62c297e22604c76573289621d16613544f85))
* Add L3GD20 gyroscope driver with FIFO, self-test, and threshold support ([#137](https://github.com/embedded-pro/embedded-infra-lib/issues/137)) ([fd11f72](https://github.com/embedded-pro/embedded-infra-lib/commit/fd11f721f97088cad4f9d0b8dd8715da4a1cd0b2))
* Add LowPriorityInterrupt and DataWatchpointAndTrace ([#99](https://github.com/embedded-pro/embedded-infra-lib/issues/99)) ([8614b49](https://github.com/embedded-pro/embedded-infra-lib/commit/8614b493e1d63b5b149862a90dad2a3ca36fb237))
* Add LSM303DLHC IMU driver with RegisterStepRunner abstraction ([#135](https://github.com/embedded-pro/embedded-infra-lib/issues/135)) ([245ba3d](https://github.com/embedded-pro/embedded-infra-lib/commit/245ba3d3f33c74ae1e8455d07f05bedd78a2641f))
* Add MPU-9250 IMU driver with core, FIFO, polling, and self-test support ([#116](https://github.com/embedded-pro/embedded-infra-lib/issues/116)) ([0d4bc41](https://github.com/embedded-pro/embedded-infra-lib/commit/0d4bc4133a33d6936ac9fcbfd463f4331adb3ba7))
* Add Nordic UART Service profile implementation for BLE ([#138](https://github.com/embedded-pro/embedded-infra-lib/issues/138)) ([1a31d45](https://github.com/embedded-pro/embedded-infra-lib/commit/1a31d45ad7c6bb0f33aac5ad3b42bc7157f02fb9))
* Add NotifyingSharedOptional::OnAllocatable overload ([#667](https://github.com/embedded-pro/embedded-infra-lib/issues/667)) ([cb37f67](https://github.com/embedded-pro/embedded-infra-lib/commit/cb37f67e787ef608dfe7f60aa5df67b05aa71508))
* Add osal/threadx/EventDispatcherThreadX ([#637](https://github.com/embedded-pro/embedded-infra-lib/issues/637)) ([8c66ddd](https://github.com/embedded-pro/embedded-infra-lib/commit/8c66dddb6d6efa5d25d097f5c7ffbc74b8362dc9))
* Add protobuf/echo/ProtoMessageBuilder ([#416](https://github.com/embedded-pro/embedded-infra-lib/issues/416)) ([f5260dd](https://github.com/embedded-pro/embedded-infra-lib/commit/f5260dd65ae4adfea14755dfef04a18074441951))
* Add Segger RTT tracing output option ([#572](https://github.com/embedded-pro/embedded-infra-lib/issues/572)) ([16529d7](https://github.com/embedded-pro/embedded-infra-lib/commit/16529d773417547c2c08163eedf6fb8ff7035227))
* Add ServiceProxyResponseQueue ([#338](https://github.com/embedded-pro/embedded-infra-lib/issues/338)) ([88cb197](https://github.com/embedded-pro/embedded-infra-lib/commit/88cb197acb2f38d3b6fad00f88983cf15d49c864))
* Add streaming of little endian mac addresses ([#336](https://github.com/embedded-pro/embedded-infra-lib/issues/336)) ([e3d7fd8](https://github.com/embedded-pro/embedded-infra-lib/commit/e3d7fd8f12ad934b98a86a6b27d8f574049f12b3))
* Add targets in order upgrade pack ([#488](https://github.com/embedded-pro/embedded-infra-lib/issues/488)) ([e528794](https://github.com/embedded-pro/embedded-infra-lib/commit/e528794ef639b5884ade70aa79f6048c3a8ccf58))
* Add VT100 terminal emulator as services/terminal ([#112](https://github.com/embedded-pro/embedded-infra-lib/issues/112)) ([8c40b07](https://github.com/embedded-pro/embedded-infra-lib/commit/8c40b074d7d35bfa096993e02191bfabda1c47e6))
* Add websocket client example ([#235](https://github.com/embedded-pro/embedded-infra-lib/issues/235)) ([d4aa174](https://github.com/embedded-pro/embedded-infra-lib/commit/d4aa1740d7ccf2d4468d6afc0c54ed4d256636ce))
* Add WithSharedAccess&lt;T&gt; wrapper ([#114](https://github.com/embedded-pro/embedded-infra-lib/issues/114)) ([69e25bc](https://github.com/embedded-pro/embedded-infra-lib/commit/69e25bc615ffd978e9f48717735415c578e5a2ee))
* Added EcDsa256 bit support for sign and verify ([#651](https://github.com/embedded-pro/embedded-infra-lib/issues/651)) ([bc39360](https://github.com/embedded-pro/embedded-infra-lib/commit/bc39360c56bf232e5ac8a951323e2bacd9f34189))
* Added generic gatt dis characteristic uuid ([#457](https://github.com/embedded-pro/embedded-infra-lib/issues/457)) ([be6fdde](https://github.com/embedded-pro/embedded-infra-lib/commit/be6fddea702f47ef816fe4fc976cdd609c1fbe87))
* Added hal/generic/UartGeneric and hal/generic/SynchronousUartGeneric ([#535](https://github.com/embedded-pro/embedded-infra-lib/issues/535)) ([799e0ee](https://github.com/embedded-pro/embedded-infra-lib/commit/799e0eeae498521471a48724fee54564ecb295d5))
* Added infra::MockFunction helper function for testing callbacks via infra::Function ([#658](https://github.com/embedded-pro/embedded-infra-lib/issues/658)) ([49810ee](https://github.com/embedded-pro/embedded-infra-lib/commit/49810eef4d70e477dc8d96b947263d621fe47bda))
* Added SerialCommunicationLoopback ([#440](https://github.com/embedded-pro/embedded-infra-lib/issues/440)) ([2c87dfb](https://github.com/embedded-pro/embedded-infra-lib/commit/2c87dfb5ecd1e76669af69a97f80c29bfab773b9))
* Ble interface improvements ([#300](https://github.com/embedded-pro/embedded-infra-lib/issues/300)) ([88a4689](https://github.com/embedded-pro/embedded-infra-lib/commit/88a4689e8f08e2afe856170aa5b5036f69d1610c))
* **ble:** Add a volatile BondStorage and report the ATT MTU from the GATT server ([#146](https://github.com/embedded-pro/embedded-infra-lib/issues/146)) ([c7a4d08](https://github.com/embedded-pro/embedded-infra-lib/commit/c7a4d08ee2e69e24e28ebe198bc8a10a6c972f93))
* **ble:** Add raw SetDataLength and SetPhy, and a decorator that drives them ([#136](https://github.com/embedded-pro/embedded-infra-lib/issues/136)) ([99c41b8](https://github.com/embedded-pro/embedded-infra-lib/commit/99c41b8d2a4fc3bb529d21bf0ac3756b1dcb4f68))
* Changed compile definitions to be compatible with the gnu assembler ([#554](https://github.com/embedded-pro/embedded-infra-lib/issues/554)) ([5a5e5dc](https://github.com/embedded-pro/embedded-infra-lib/commit/5a5e5dca2cc522875b13f8a8ceebc73037dc0c94))
* Changed EMIL_ENABLE_GLOBAL_TRACING define to EMIL_ENABLE_TRACING and EMIL_DISABLE_TRACING ([#521](https://github.com/embedded-pro/embedded-infra-lib/issues/521)) ([2d4eb48](https://github.com/embedded-pro/embedded-infra-lib/commit/2d4eb489817fc36b35ff758bf4d9acbc3e7ceda5))
* Crc with automatic table generation ([#636](https://github.com/embedded-pro/embedded-infra-lib/issues/636)) ([23ac162](https://github.com/embedded-pro/embedded-infra-lib/commit/23ac162fbd3be451bd0b6a3d4488e6c8b9d38b1b))
* Dd elliptic curve ([#14](https://github.com/embedded-pro/embedded-infra-lib/issues/14)) ([71e59b8](https://github.com/embedded-pro/embedded-infra-lib/commit/71e59b877a4e18de0294ff1fd4b289ca0dc43f03))
* Disabled documentation warning when compiling with AppleClang ([#618](https://github.com/embedded-pro/embedded-infra-lib/issues/618)) ([5fd230a](https://github.com/embedded-pro/embedded-infra-lib/commit/5fd230aa0c71787108fa7320dddc3478eee8b2ac))
* **drivers:** Verify DRV8711 configuration by read-back, fix RESET polarity ([#144](https://github.com/embedded-pro/embedded-infra-lib/issues/144)) ([d9e64d8](https://github.com/embedded-pro/embedded-infra-lib/commit/d9e64d878f16524d0178e050963b32b42e9abc1a))
* Extend gpio interrupt interface to enable immediate interrupt handlers ([#721](https://github.com/embedded-pro/embedded-infra-lib/issues/721)) ([95ddf85](https://github.com/embedded-pro/embedded-infra-lib/commit/95ddf856192b8eb7e7282f3cb6f4e028aef200ad))
* Flash sfdp autodiscovery ([#94](https://github.com/embedded-pro/embedded-infra-lib/issues/94)) ([321a369](https://github.com/embedded-pro/embedded-infra-lib/commit/321a369d9ef75a41b212c38578aba774bd47bfb0))
* Forward tags to scenario request handler ([#483](https://github.com/embedded-pro/embedded-infra-lib/issues/483)) ([a66f711](https://github.com/embedded-pro/embedded-infra-lib/commit/a66f711cd582fa099fe92db0d4995d2f052aba19))
* **fsm:** Flash-resident table, entered hooks, mapped completions and handled-event tracing ([#141](https://github.com/embedded-pro/embedded-infra-lib/issues/141)) ([28ee6de](https://github.com/embedded-pro/embedded-infra-lib/commit/28ee6de4ab3cc50603d8d782ddde27fbe2506f85))
* Gap proto extension before sesame ([#688](https://github.com/embedded-pro/embedded-infra-lib/issues/688)) ([d5efa72](https://github.com/embedded-pro/embedded-infra-lib/commit/d5efa729fd51f7c734e6ee751eb255f4acfc8246))
* Generate string literals ([#699](https://github.com/embedded-pro/embedded-infra-lib/issues/699)) ([d272b1f](https://github.com/embedded-pro/embedded-infra-lib/commit/d272b1f8774435755ecb8e0e51f8a1873612b692))
* Generic pairing/bonding classes updated ([#330](https://github.com/embedded-pro/embedded-infra-lib/issues/330)) ([dbda405](https://github.com/embedded-pro/embedded-infra-lib/commit/dbda405cc2ef2d356fbe707df5389042a49c7959))
* Hal qemu ([#90](https://github.com/embedded-pro/embedded-infra-lib/issues/90)) ([9c3d4c3](https://github.com/embedded-pro/embedded-infra-lib/commit/9c3d4c32bba0123abdc0013b8b9d5aea26e1f103))
* **hal:** Add watchdog and low-power interfaces, and an event dispatcher with watchdog supervision ([#149](https://github.com/embedded-pro/embedded-infra-lib/issues/149)) ([501b20e](https://github.com/embedded-pro/embedded-infra-lib/commit/501b20e42efc14d6338239ddbf48d6a3ced0d34e))
* **hal:** Take PWM duty cycles as a Q16 hal::DutyCycle ([#142](https://github.com/embedded-pro/embedded-infra-lib/issues/142)) ([93f6584](https://github.com/embedded-pro/embedded-infra-lib/commit/93f6584193046901f7c0534c88489d21088d516a))
* HttpClientBasic will now reset the contentError flag before a new connection is attempted ([#598](https://github.com/embedded-pro/embedded-infra-lib/issues/598)) ([c0e6755](https://github.com/embedded-pro/embedded-infra-lib/commit/c0e67552bc328b1947f44ed0370cea6820c0512d))
* Implement persisted mbed tls session ([#602](https://github.com/embedded-pro/embedded-infra-lib/issues/602)) ([53d45ce](https://github.com/embedded-pro/embedded-infra-lib/commit/53d45ce8006c6a6e504ee90266feaa8b3ad235bc))
* Made EventDispatcher and EventDispatcherWithWeakptr exception safe when executing an action ([#525](https://github.com/embedded-pro/embedded-infra-lib/issues/525)) ([46a118c](https://github.com/embedded-pro/embedded-infra-lib/commit/46a118c9d792981f282abcf8bb980bc754aa152b))
* Merge upstream changes ([#279](https://github.com/embedded-pro/embedded-infra-lib/issues/279)) ([9856f23](https://github.com/embedded-pro/embedded-infra-lib/commit/9856f2304b818f69926db810aabadbd2c1a82659))
* Move the GATT client to a per-connection architecture ([#118](https://github.com/embedded-pro/embedded-infra-lib/issues/118)) ([5ff138b](https://github.com/embedded-pro/embedded-infra-lib/commit/5ff138b61b5cba86f5500f649fb712ebb4acaaca))
* Optional tracing ([#489](https://github.com/embedded-pro/embedded-infra-lib/issues/489)) ([0c594d9](https://github.com/embedded-pro/embedded-infra-lib/commit/0c594d954fa1e5d9458d0dbbbd8f186da735793a))
* Promote all qemu/cortex components to cortex_m ([#104](https://github.com/embedded-pro/embedded-infra-lib/issues/104)) ([b2ac7ed](https://github.com/embedded-pro/embedded-infra-lib/commit/b2ac7ed7f6121f9aa1b1e15a68986af0cfca63de))
* Protobuf: add support for optional keyword ([#661](https://github.com/embedded-pro/embedded-infra-lib/issues/661)) ([82032aa](https://github.com/embedded-pro/embedded-infra-lib/commit/82032aaeceed20d8b5fd588456e9b600da7a8263))
* Protobuf: add support for optional keyword ([#665](https://github.com/embedded-pro/embedded-infra-lib/issues/665)) ([b33ed06](https://github.com/embedded-pro/embedded-infra-lib/commit/b33ed0647d149cb6af81bcbe9daeeb6c4c6e92ab))
* Refactor adc to support multiple samples ([#530](https://github.com/embedded-pro/embedded-infra-lib/issues/530)) ([419f636](https://github.com/embedded-pro/embedded-infra-lib/commit/419f636bd76f2c0ee2f7524ca548e724bf479e27))
* Removed Dac.hpp ([#439](https://github.com/embedded-pro/embedded-infra-lib/issues/439)) ([4b52156](https://github.com/embedded-pro/embedded-infra-lib/commit/4b5215609b9ee2a6ca72d8d660b8c797aa3e31c9))
* Security for MessageCommunication ([#294](https://github.com/embedded-pro/embedded-infra-lib/issues/294)) ([f6c3f56](https://github.com/embedded-pro/embedded-infra-lib/commit/f6c3f56e73a8324f87476908a1ef07f243350093))
* Services/network/HttpClientBasic is now able to process more than 1 request ([#576](https://github.com/embedded-pro/embedded-infra-lib/issues/576)) ([0df2625](https://github.com/embedded-pro/embedded-infra-lib/commit/0df26250e0e0894e7a3bb9af2d0306aa4d6cc312))
* **services:** Add a software SHA-256 and a persistent BondStorage ([#148](https://github.com/embedded-pro/embedded-infra-lib/issues/148)) ([f505e02](https://github.com/embedded-pro/embedded-infra-lib/commit/f505e0201ed4413982e15924839d1b1b122fa666))
* Sesame stack which does not execute in interrupt context ([#514](https://github.com/embedded-pro/embedded-infra-lib/issues/514)) ([4dc5736](https://github.com/embedded-pro/embedded-infra-lib/commit/4dc5736b2814734a66a1de75d2eabb356d1ed6ff))
* Split GAP into central and peripheral roles with asynchronous, status returning operations ([#117](https://github.com/embedded-pro/embedded-infra-lib/issues/117)) ([2cb78cd](https://github.com/embedded-pro/embedded-infra-lib/commit/2cb78cdbff6a3968bfd418812d0da9aa7b07f4e0))
* Support payloads bigger than the MaxSendStreamSize ([#331](https://github.com/embedded-pro/embedded-infra-lib/issues/331)) ([c411f66](https://github.com/embedded-pro/embedded-infra-lib/commit/c411f66f7ae972786a7fa1134989ab8e4f0631aa))
* Support streaming echo messages ([#435](https://github.com/embedded-pro/embedded-infra-lib/issues/435)) ([07756bb](https://github.com/embedded-pro/embedded-infra-lib/commit/07756bb41f068adbf3a2eb76adb2778fff5491f0))
* Update usb interface ([2b9fcb7](https://github.com/embedded-pro/embedded-infra-lib/commit/2b9fcb7b3e385669141604776217268741b8e876))
* Update usb interface ([a955fab](https://github.com/embedded-pro/embedded-infra-lib/commit/a955fab6f32ef020f853de01d118cf3934208ce6))
* Update usb interface ([d0d47dc](https://github.com/embedded-pro/embedded-infra-lib/commit/d0d47dc608aba2cd3f2e2931df1f60e57d455760))
* Update usb interface ([e82c7d0](https://github.com/embedded-pro/embedded-infra-lib/commit/e82c7d0bbcb976325a985119575eab0c2a912136))
* Usb host ([2bf858e](https://github.com/embedded-pro/embedded-infra-lib/commit/2bf858e41315fa26417c172d4fcaf39ea2c3c12e))
* Usb host ([d928d0a](https://github.com/embedded-pro/embedded-infra-lib/commit/d928d0a4e354fbe035b981de3f9082c007a5ddd5))
* Workaround OutputStream optimization issue with Visual Studio 2019 ([#258](https://github.com/embedded-pro/embedded-infra-lib/issues/258)) ([ea3de1e](https://github.com/embedded-pro/embedded-infra-lib/commit/ea3de1eeaf99649cdbf558cf11c650795662c2e9))


### Bug Fixes

* Add acd sources to lwip ([#400](https://github.com/embedded-pro/embedded-infra-lib/issues/400)) ([a4f68ef](https://github.com/embedded-pro/embedded-infra-lib/commit/a4f68efdf19e7b556cb6fe2cba0165908f56be8c))
* Add LR diagnostic to abort() and remove C-style formatting ([#113](https://github.com/embedded-pro/embedded-infra-lib/issues/113)) ([18bc81f](https://github.com/embedded-pro/embedded-infra-lib/commit/18bc81f5a0e50126a5434e69ee04a35425b30769))
* Added workaround mbedtls and clang-cl incomatibility ([#441](https://github.com/embedded-pro/embedded-infra-lib/issues/441)) ([063b595](https://github.com/embedded-pro/embedded-infra-lib/commit/063b59508f1d09c2675b338c7b54d64934f7792c))
* Avoid overflow when scheduling TimerSingleShot ([#612](https://github.com/embedded-pro/embedded-infra-lib/issues/612)) ([ea4683c](https://github.com/embedded-pro/embedded-infra-lib/commit/ea4683c464a2272936995bc89a9ff9bed506d1a7))
* Backport upstream bug fixes from amp-embedded-infra-lib ([#105](https://github.com/embedded-pro/embedded-infra-lib/issues/105)) ([8cd6166](https://github.com/embedded-pro/embedded-infra-lib/commit/8cd6166b45ad7671a5a41feacf7a8cb0b771d630))
* Ble advertisement parser erroneous data handling ([#600](https://github.com/embedded-pro/embedded-infra-lib/issues/600)) ([f6d6b5e](https://github.com/embedded-pro/embedded-infra-lib/commit/f6d6b5efb7ee6bad5d13079310d40280803586c7))
* **ble:** Align GAP and GATT with the Bluetooth Core Specification ([#132](https://github.com/embedded-pro/embedded-infra-lib/issues/132)) ([8e92649](https://github.com/embedded-pro/embedded-infra-lib/commit/8e9264961582ad630418b37fcf6a49e606676414))
* BufferingStreamReader OOB access and Echo segments calculated correctly ([#569](https://github.com/embedded-pro/embedded-infra-lib/issues/569)) ([b1c1d12](https://github.com/embedded-pro/embedded-infra-lib/commit/b1c1d12d8bb3414cfd52b6b295388c472c1f7f12))
* Ccache ([#17](https://github.com/embedded-pro/embedded-infra-lib/issues/17)) ([2834a8c](https://github.com/embedded-pro/embedded-infra-lib/commit/2834a8cd60244125a9237a466a04c7219b5be61d))
* ConnectionMbedTls no longer calls DataReceived() with 0 bytes ([#585](https://github.com/embedded-pro/embedded-infra-lib/issues/585)) ([cd74d66](https://github.com/embedded-pro/embedded-infra-lib/commit/cd74d664717066664cbb99cc7619a7919dffbcac))
* Correct order of destruction in EchoForwarderToSerial. ([#291](https://github.com/embedded-pro/embedded-infra-lib/issues/291)) ([3267831](https://github.com/embedded-pro/embedded-infra-lib/commit/32678313eb79ee84165c358cb392e5915323ab64))
* Corrected incorrect destructor syntax ([#460](https://github.com/embedded-pro/embedded-infra-lib/issues/460)) ([e01dd98](https://github.com/embedded-pro/embedded-infra-lib/commit/e01dd985d0d4699dc859d3e8fc375c72dccf8a89))
* Cpp:S6232 well-defined type-punning method should be used instead of a union-based one ([d809c17](https://github.com/embedded-pro/embedded-infra-lib/commit/d809c173cacefd3bf2d661718111d5d301a95fc1))
* CucumberWireProtocolFormatter; max string value size does not fit into stepMatchArgumentsBuffer. ([#311](https://github.com/embedded-pro/embedded-infra-lib/issues/311)) ([5504202](https://github.com/embedded-pro/embedded-infra-lib/commit/55042025bfe5c631a2c247a6e90a23d0f437a2fb))
* Decouple host and embedded builds ([#225](https://github.com/embedded-pro/embedded-infra-lib/issues/225)) ([d443b16](https://github.com/embedded-pro/embedded-infra-lib/commit/d443b165b0b2bc821735aa10e6c2fa392299f1fe))
* Destruction of HttpClientJson while resetting the reader resulted in memory corruption ([#404](https://github.com/embedded-pro/embedded-infra-lib/issues/404)) ([ed8a8a0](https://github.com/embedded-pro/embedded-infra-lib/commit/ed8a8a0e5893074fc56fde94cfdb003a870e930c))
* Detaching HttpClient while in HeaderAvailable resulted in a crash ([#406](https://github.com/embedded-pro/embedded-infra-lib/issues/406)) ([a905a30](https://github.com/embedded-pro/embedded-infra-lib/commit/a905a306be194c7cf6380e70cf83b668c8d27425))
* Duplicate header guard HAL_UART_HOST_HPP ([#558](https://github.com/embedded-pro/embedded-infra-lib/issues/558)) ([a8b1e63](https://github.com/embedded-pro/embedded-infra-lib/commit/a8b1e639d42718fab274590a38f548ffe02270c0))
* Echo: only ContinueReceiveMessage() when readerPtr != nullptr ([#701](https://github.com/embedded-pro/embedded-infra-lib/issues/701)) ([81c87c4](https://github.com/embedded-pro/embedded-infra-lib/commit/81c87c4926cbdb89830c4003277a1919a26a6cec))
* **echo:** Build native ECHO plugins from the EMIL source tree ([#145](https://github.com/embedded-pro/embedded-infra-lib/issues/145)) ([ac562f9](https://github.com/embedded-pro/embedded-infra-lib/commit/ac562f95ed0fd06b5e5b8a05b0d85205498bfde7))
* **echo:** Fix generation of tracer class for empty services ([#671](https://github.com/embedded-pro/embedded-infra-lib/issues/671)) ([751fefd](https://github.com/embedded-pro/embedded-infra-lib/commit/751fefdd673e364c492efcaa2bf892281f73c396))
* **echo:** Support serializing nested messages ([#670](https://github.com/embedded-pro/embedded-infra-lib/issues/670)) ([63c55e0](https://github.com/embedded-pro/embedded-infra-lib/commit/63c55e048888397a3b163762e919256e4fe1f2da))
* Emil test helpers ([#87](https://github.com/embedded-pro/embedded-infra-lib/issues/87)) ([2848dbf](https://github.com/embedded-pro/embedded-infra-lib/commit/2848dbf163a6ebf159e29f7f4f73b96f7773d20d))
* Enable service scoping of method invocations in services.echo_console ([#325](https://github.com/embedded-pro/embedded-infra-lib/issues/325)) ([7090a40](https://github.com/embedded-pro/embedded-infra-lib/commit/7090a407f50d89073c468381e5207f1c0f56b6c1))
* Ensure forwarding constructors have constraints ([#290](https://github.com/embedded-pro/embedded-infra-lib/issues/290)) ([5015938](https://github.com/embedded-pro/embedded-infra-lib/commit/50159383787e330ea784b684da5f6dfc47b49113))
* GattClient notification ([#284](https://github.com/embedded-pro/embedded-infra-lib/issues/284)) ([15ff387](https://github.com/embedded-pro/embedded-infra-lib/commit/15ff3873f9f57169217c6a4337f9fac7d1b1f032))
* Handle echo message split over multiple streams ([#481](https://github.com/embedded-pro/embedded-infra-lib/issues/481)) ([37d7878](https://github.com/embedded-pro/embedded-infra-lib/commit/37d7878f709090e9d556e9b84c7bf6eeafa1c6e0))
* Heap memory leak on SerializerFactory::OnHeap ([#561](https://github.com/embedded-pro/embedded-infra-lib/issues/561)) ([0ed606b](https://github.com/embedded-pro/embedded-infra-lib/commit/0ed606bb6fdb925e1511314d4f3b25ab19632a18))
* HttpClientBasic reporting error for reestablished connections ([#473](https://github.com/embedded-pro/embedded-infra-lib/issues/473)) ([0619299](https://github.com/embedded-pro/embedded-infra-lib/commit/0619299fb6330cd7cee92ac952fad229317f64f3))
* Incorrect handling of float numbers in json ([#478](https://github.com/embedded-pro/embedded-infra-lib/issues/478)) ([c8ee456](https://github.com/embedded-pro/embedded-infra-lib/commit/c8ee456e6936a76a1e7cc3ab18198b7def9d2834))
* Infra/util/Endian: fix comparison against C++ version ([#486](https://github.com/embedded-pro/embedded-infra-lib/issues/486)) ([4fe74e5](https://github.com/embedded-pro/embedded-infra-lib/commit/4fe74e5751c90eca2786d263cbf6bca1520a4aba))
* Line termination mismatch in hex files ([#307](https://github.com/embedded-pro/embedded-infra-lib/issues/307)) ([47482c3](https://github.com/embedded-pro/embedded-infra-lib/commit/47482c3b02e76d13437413cfb802e317439a4300))
* Networking on linux ([#594](https://github.com/embedded-pro/embedded-infra-lib/issues/594)) ([972ff81](https://github.com/embedded-pro/embedded-infra-lib/commit/972ff816320440f3ee837d14c50b8c8aa6a516d6))
* Null json value ([#470](https://github.com/embedded-pro/embedded-infra-lib/issues/470)) ([e72d48f](https://github.com/embedded-pro/embedded-infra-lib/commit/e72d48fd105cd8b9fd2cfe5d780a91e4591f89bd))
* Pad 0xff when add hex and elf to upgrade pack ([#646](https://github.com/embedded-pro/embedded-infra-lib/issues/646)) ([5c5d318](https://github.com/embedded-pro/embedded-infra-lib/commit/5c5d3186c45e3463d57535a1d07cf011da91f6dc))
* Protobuf/echo/EchoInstantiation: fix compilation errors ([#267](https://github.com/embedded-pro/embedded-infra-lib/issues/267)) ([9b53dc1](https://github.com/embedded-pro/embedded-infra-lib/commit/9b53dc1f77f944ce17d060a7d14fb5087f035677))
* RAII for SystemTickTimerService and add LowPowerStrategyCortex ([#110](https://github.com/embedded-pro/embedded-infra-lib/issues/110)) ([bce09c3](https://github.com/embedded-pro/embedded-infra-lib/commit/bce09c3931ec821d956be5c62a71db5c264718fb))
* Remove \r from end of line of certificates ([#510](https://github.com/embedded-pro/embedded-infra-lib/issues/510)) ([7f581d8](https://github.com/embedded-pro/embedded-infra-lib/commit/7f581d87f7eab9d0b4635c25886d9b100cac22a3))
* Remove echo dependency from network instantiations ([#63](https://github.com/embedded-pro/embedded-infra-lib/issues/63)) ([74c4ff1](https://github.com/embedded-pro/embedded-infra-lib/commit/74c4ff1b94c34c32af963ff141176b1d207e893d))
* Remove superfluous &gt; from cmake/emil_xsltproc.cmake ([#276](https://github.com/embedded-pro/embedded-infra-lib/issues/276)) ([be139b2](https://github.com/embedded-pro/embedded-infra-lib/commit/be139b22aff7dd5998eba2d7c409302598f988fb))
* Remove virtual destructors reducing binary size ([#502](https://github.com/embedded-pro/embedded-infra-lib/issues/502)) ([fc69a3c](https://github.com/embedded-pro/embedded-infra-lib/commit/fc69a3c85b2a89018d4c9503378737a967912b31))
* Repeated proto message incorrect maxMessageSize calculation ([#617](https://github.com/embedded-pro/embedded-infra-lib/issues/617)) ([2d28a51](https://github.com/embedded-pro/embedded-infra-lib/commit/2d28a51a94ab9f41bd776f16db47ed3ad8335e2c))
* ServiceForwarder with LimitedStreamReader ends up in infinite loop ([#524](https://github.com/embedded-pro/embedded-infra-lib/issues/524)) ([9e7f949](https://github.com/embedded-pro/embedded-infra-lib/commit/9e7f949e96493a2dd4240995b535b3c23d455e51))
* Services.echo_console: parsing tokens of nested messages and arrays, formatting of messages, and properly close upon losing connection ([#712](https://github.com/embedded-pro/embedded-infra-lib/issues/712)) ([4a69845](https://github.com/embedded-pro/embedded-infra-lib/commit/4a69845e0b2ffa44a96b80a792db5a9b44e98742))
* Services/network/ConnectionMbedTls: Hostname() may not be invoked after ConnectionEstablished() ([#609](https://github.com/embedded-pro/embedded-infra-lib/issues/609)) ([fcc469a](https://github.com/embedded-pro/embedded-infra-lib/commit/fcc469aa899cac1fd712016cf8a0c05a89e27637))
* Services/network/WebSocketClientConnectionObserver: Don't close websocket connection after 1 minute ([#578](https://github.com/embedded-pro/embedded-infra-lib/issues/578)) ([d2e0c05](https://github.com/embedded-pro/embedded-infra-lib/commit/d2e0c05d916aeeb88551e42306161ce372bf1aa1))
* Tcp packet fragmentation ([#700](https://github.com/embedded-pro/embedded-infra-lib/issues/700)) ([c419e54](https://github.com/embedded-pro/embedded-infra-lib/commit/c419e5473bdb46fa90bd7282614435f5ab511a10))
* Timer jumped shall trigger next trigger time update ([9bbfb53](https://github.com/embedded-pro/embedded-infra-lib/commit/9bbfb535061a56e76cf9e1aa037269030efff144))
* Timer jumped will trigger next trigger time update ([#590](https://github.com/embedded-pro/embedded-infra-lib/issues/590)) ([9bbfb53](https://github.com/embedded-pro/embedded-infra-lib/commit/9bbfb535061a56e76cf9e1aa037269030efff144))
* Timer limited repeat ([#659](https://github.com/embedded-pro/embedded-infra-lib/issues/659)) ([4f2a49e](https://github.com/embedded-pro/embedded-infra-lib/commit/4f2a49ee501f358965bdb54737f666cf1bafb407))
* Trace outgoing echo calls ([#710](https://github.com/embedded-pro/embedded-infra-lib/issues/710)) ([279bb62](https://github.com/embedded-pro/embedded-infra-lib/commit/279bb6295d1d1c0d7fa9849e6a7ca04805ab84b0))
* UartUnix receiveData callback being called after destruction ([#677](https://github.com/embedded-pro/embedded-infra-lib/issues/677)) ([65f164b](https://github.com/embedded-pro/embedded-infra-lib/commit/65f164b480720379607497f61ad276f35d0474c2))
* UpgradePackBuilderFacade setting mbedtls global memory pool on stack ([#324](https://github.com/embedded-pro/embedded-infra-lib/issues/324)) ([ec567d5](https://github.com/embedded-pro/embedded-infra-lib/commit/ec567d511f40eb3c0962ac4b6ac3479f64c0a871))
* UpgradePackBuilderFacade setting mbedtls global memory pool on stack, causing a crash when combined with ConnectionMbedTls ([ec567d5](https://github.com/embedded-pro/embedded-infra-lib/commit/ec567d511f40eb3c0962ac4b6ac3479f64c0a871))
* Usable memory loss in HttpClientBasic::Path ([#304](https://github.com/embedded-pro/embedded-infra-lib/issues/304)) ([d5d4abf](https://github.com/embedded-pro/embedded-infra-lib/commit/d5d4abf32050cf92bf7c55c5eb227007d04d88e3))
* Various fixes for echo  ([#462](https://github.com/embedded-pro/embedded-infra-lib/issues/462)) ([0062598](https://github.com/embedded-pro/embedded-infra-lib/commit/006259893b8bd57b7c0796977cd96fc4bfbcc626))
