...
https://sonarcloud.io/summary/new_code?id=embedded-pro_embeddedinfralib[image:https://sonarcloud.io/api/project_badges/measure?project=embedded-pro_embeddedinfralib&metric=ncloc[Lines
of Code]] https://sonarcloud.io/summary/new_code?id=embedded-pro_embeddedinfralib[image:https://sonarcloud.io/api/project_badges/measure?project=embedded-pro_embeddedinfralib&metric=coverage[Coverage]] https://sonarcloud.io/summary/new_code?id=embedded-pro_embeddedinfralib[image:https://sonarcloud.io/api/project_badges/measure?project=embedded-pro_embeddedinfralib&metric=reliability_rating[Reliability
Rating]] https://sonarcloud.io/summary/new_code?id=embedded-pro_embeddedinfralib[image:https://sonarcloud.io/api/project_badges/measure?project=embedded-pro_embeddedinfralib&metric=security_rating[Security
Rating]] https://sonarcloud.io/summary/new_code?id=embedded-pro_embeddedinfralib[image:https://sonarcloud.io/api/project_badges/measure?project=embedded-pro_embeddedinfralib&metric=sqale_rating[Maintainability
Rating]]
...
`infra::BoundedString` is similar to `std::string` except that it can contain a maximum number of characters, and is not zero-terminated by default (see GitHub issue https://github.com/embedded-pro/embeddedinfralib/issues/37[#37]).
