...
namespace services
{
    ...
    private:
        ...
        {
        public:
            UdpWriter(udp_pcb* control, pbuf* buffer, const std::optional<UdpSocket>& remote);
            ~UdpWriter();
        ...
        {
        public:
            StateWaitingForBuffer(DatagramExchangeLwIP& datagramExchange, std::size_t sendSize, const std::optional<UdpSocket>& remote);
