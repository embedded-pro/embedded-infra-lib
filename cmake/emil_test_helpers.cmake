...
function(emil_fetch_googletest)
    ...
    set_target_properties(gtest gtest_main gmock gmock_main PROPERTIES COMPILE_WARNING_AS_ERROR Off)
    ...
    if (NOT EMIL_HOST_BUILD)
        foreach(target gtest gtest_main gmock gmock_main)
            target_compile_definitions(${target} PUBLIC GTEST_HAS_FILE_SYSTEM=0)
        endforeach()
    endif()
endfunction()
