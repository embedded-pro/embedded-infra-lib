...
{
    infra::StdVectorInputStream::WithStorage stream(infra::inPlace, std::vector<uint8_t>{ 5 });
...
{
    infra::StdVectorInputStream::WithStorage stream(infra::inPlace, std::vector<uint8_t>{ 0x85, 3 });
    infra::ProtoParser parser(stream);
...
{
    infra::StdVectorInputStream::WithStorage stream(infra::inPlace, std::vector<uint8_t>{ 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 1 });
    infra::ProtoParser parser(stream);
...
{
    infra::StdVectorInputStream::WithStorage stream(infra::inPlace, std::vector<uint8_t>{ 1, 0, 0, 0 });
    infra::ProtoParser parser(stream);
...
{
    infra::StdVectorInputStream::WithStorage stream(infra::inPlace, std::vector<uint8_t>{ 1, 0, 0, 0, 0, 0, 0, 0 });
    infra::ProtoParser parser(stream);
...
{
    infra::StdVectorInputStream::WithStorage stream(infra::inPlace, std::vector<uint8_t>{ 1 << 3, 5 });
    infra::ProtoParser parser(stream);
...
{
    infra::StdVectorInputStream::WithStorage stream(infra::inPlace, std::vector<uint8_t>{ (1 << 3) | 1, 5, 0, 0, 0, 0, 0, 0, 0 });
    infra::ProtoParser parser(stream);
...
{
    infra::StdVectorInputStream::WithStorage stream(infra::inPlace, std::vector<uint8_t>{ (1 << 3) | 5, 5, 0, 0, 0 });
    infra::ProtoParser parser(stream);
...
{
    infra::StdVectorInputStream::WithStorage stream(infra::inPlace, std::vector<uint8_t>{ (1 << 3) | 2, 1, 'a' });
    infra::ProtoParser parser(stream);
...
{
    infra::StdVectorInputStream::WithStorage stream(infra::inPlace, std::vector<uint8_t>{ 1 << 3 | 4, 5 }, infra::softFail);
    infra::ProtoParser parser(stream);
...
{
    infra::StdVectorInputStream::WithStorage stream(infra::inPlace, std::vector<uint8_t>{ (1 << 3) | 2, 5, 'a', 'b', 'c' }, infra::softFail);
    infra::ProtoParser parser(stream);
...
{
    infra::StdVectorInputStream::WithStorage stream(infra::inPlace, std::vector<uint8_t>{ (1 << 3) | 2, 1, 5 });
    infra::ProtoParser parser(stream);
...
{
    infra::StdVectorInputStream::WithStorage stream(infra::inPlace, std::vector<uint8_t>{ (1 << 3) | 2, 5, 5, 6, 7 }, infra::softFail);
    infra::ProtoParser parser(stream);
...
{
    infra::StdVectorInputStream::WithStorage stream(infra::inPlace, std::vector<uint8_t>{ (1 << 3) | 2, 2, 1 << 3, 5 });
    infra::ProtoParser parser(stream);
...
{
    infra::StdVectorInputStream::WithStorage stream(infra::inPlace, std::vector<uint8_t>{ (1 << 3) | 2, 2, 1 << 3, 5, 1 << 3, 5 });
    infra::ProtoParser parser(stream);
